...
extern "C" {
    ...
    extern void LCD_PutASCIICharXY(const uint8_t *buffer, const char character, int x, int y);
    extern void LCD_PutGBKCharXY(const uint8_t *buffer, const uint16_t character, int x, int y);

    extern void LCD_PutCharXY(const uint8_t *buffer, const char *ptr_char, int x, int y);

    extern void LCD_PrintStrXY(const uint8_t *buffer, const char *str, int x, int y);
